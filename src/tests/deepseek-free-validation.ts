...
import { isDeepSeekR1, isDeepSeekR1FreeOpenRouter } from '../components/deepseek-free-openrouter-ui';
...
const validationChecklist = [
  ...
  },
  {
    ...
    validate: () => {
      ...
      const blocksPasswordFields = COMPUTER_USE_SECURITY_RULES.blockedOperations.includes('password_field_interaction');
      const blocksPaymentFields = COMPUTER_USE_SECURITY_RULES.blockedOperations.includes('payment_field_interaction');
