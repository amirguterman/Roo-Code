...
import { getComputerPrompt, isDolphinModel, isQwenModel, isOpenRouterComputerUseModel } from '../core/prompts/computer';
...
const testDolphinPromptPreparation = async () => {
  ...
  console.log('Result includes computer prompt:', result.includes(getComputerPrompt('cognitivecomputations/dolphin3.0-r1-mistral-24b:free')));
  console.log('---');
  
  return result.includes(getComputerPrompt('cognitivecomputations/dolphin3.0-r1-mistral-24b:free'));
};
...
const testQwenPromptPreparation = async () => {
  ...
  console.log('Result includes computer prompt:', result.includes(getComputerPrompt('qwen/qwen-2.5-coder-32b-instruct:free')));
  console.log('---');
  
  return result.includes(getComputerPrompt('qwen/qwen-2.5-coder-32b-instruct:free'));
};
...
const runAllTests = async () => {
  ...
  const allPassed = test1Result && test2Result && test3Result && test4Result && test5Result && test6Result && test7Result;
